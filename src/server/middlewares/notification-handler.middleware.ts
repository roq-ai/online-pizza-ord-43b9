...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'pizza.update': { roles: ['team-member'], key: 'pizza-menu-update', tenantPath: [], userPath: [] },
  'pizza.delete': { roles: ['team-member'], key: 'pizza-menu-delete', tenantPath: [], userPath: [] },
  'order.update': {
    roles: ['user'],
    key: 'order-status-update',
    tenantPath: ['organization', 'user', 'order'],
    userPath: [],
  },
};
...
const tenantRoles: string[] = ['business-owner', 'team-member', 'developer', 'quality-assurance'];
