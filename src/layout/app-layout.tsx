...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['business-owner', 'team-member', 'developer', 'quality-assurance'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Pizzas', path: '/pizzas', entity: 'pizza', service: AccessServiceEnum.PROJECT, icon: FiBox },
